...
| :--- | :--- | :--- |
| **提出新需求 / 做个功能** | `.agent/workflows/ai-review.md` | `/ai-review` (推荐) |
| **拆解大任务 / 细化设计** | `.agent/workflows/prd-decomposition.md` | `/decompose` |
| **开始开发 / 交付流水线 (Manifest)** | `.agent/workflows/rd-implementation.md` | `/feature-flow` |
...
```
项目根目录/
├── .agent/                    # Agent 配置 (如果存在则启用 Agent OS)
│   ├── memory/               # 记忆系统
│   ├── rules/                # 路由规则
│   ├── skills/               # 项目级技能
│   └── workflows/            # 工作流定义
...
_Antigravity Agent OS v4.2 — Kiro Adapter (Hybrid)_
